...
NUM_ESTIMATORS = config['polynomial']['small_model']['num_of_estimators']
NUM_JOBS = config['polynomial']['small_model']['num_of_jobs']
FS = 96000
T_END = 1
...
regressor_amp = joblib.load(
    os.path.join(MODELS_PATH, config['polynomial']['models_location'], 'polynomial_small.pkl')
)
# predicted out
