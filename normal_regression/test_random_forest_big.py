...
regressor_amp = joblib.load(
    os.path.join(MODELS_PATH, config['random_forest']['models_location'], 'random_forest_big.pkl')
)
# predicted out
...
PLOT_PATH = os.path.join(os.path.dirname(os.path.abspath('test_polynomial_big.py')), 'plots')
