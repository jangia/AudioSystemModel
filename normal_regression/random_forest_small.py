...
# save model
BASE_DIR = os.path.dirname(os.path.abspath('config.py'))
joblib.dump(
    regressor_amp,
    os.path.join(BASE_DIR, config['random_forest']['models_location'], 'random_forest_small_{0}.pkl'.format(datetime.datetime.now()))
)
